...
namespace MadXchange.Connector.Services
{
    ...
    /// </summary>
    public class ExchangeCommandExecutionService : IExchangeRequestService
    {
        ...
        public ExchangeCommandExecutionService(IPositionRequestService positionRequestService, IOrderRequestService orderRequestService, ILogger<ExchangeCommandExecutionService> logger) 
        {
